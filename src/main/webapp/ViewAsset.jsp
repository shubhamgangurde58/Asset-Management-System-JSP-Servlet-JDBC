			...
			<table>
					...
					try{
						...
						if(search != null && !search.trim().isEmpty()){
							...
							if(isNumber){
								...
								pstmt = DBConnection.getConnection().prepareStatement("select * from assets where id=?");
								...
								pstmt = DBConnection.getConnection().prepareStatement("select * from assets where assetName like ?");
							...
							pstmt = DBConnection.getConnection().prepareStatement("select * from assets");
				...
				<tr>
					...
					<td>
						...
						<a href="UpdateAsset.jsp?id=<%= rs.getInt("id") %>"
						class="edit-btn">
					...
					<td>
						...
						<a href="DeleteAsset?id=<%= rs.getInt("id") %>"
						class="delete-btn"
